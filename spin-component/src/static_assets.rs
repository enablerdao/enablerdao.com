...
const SS_KAGI_W600: &[u8] = include_bytes!("../../static/screenshots/kagi-home.w600.webp");
const SS_PASHA: &[u8] = include_bytes!("../../static/screenshots/pasha-home.jpg");
const SS_PASHA_W600: &[u8] = include_bytes!("../../static/screenshots/pasha-home.w600.webp");
...
pub fn serve_static(path: &str) -> Option<Response> {
    ...
    match path {
        ...
        "/static/screenshots/kagi-home.w600.webp" => Some(bytes_response(SS_KAGI_W600, "image/webp")),
        "/static/screenshots/pasha-home.jpg" => Some(bytes_response(SS_PASHA, "image/jpeg")),
        "/static/screenshots/pasha-home.w600.webp" => Some(bytes_response(SS_PASHA_W600, "image/webp")),
